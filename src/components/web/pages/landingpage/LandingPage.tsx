      ...
      <section className="p-8 leading-tight bg-green text-white ">
        <header>
          ...
          <p className="mt-5 font-semibold">
            Reactify&trade; is an open source Spotify client completely build using ReactJS. The goal is to use the
            potential of the Spotify API as much as possible and provide a seamless experience.
          </p>
        </header>
      </section>
      <main>
        ...
        <section className="px-8 py-12">
          ...
          <p className="mt-5">
            ...
            Reactify is not associated, endorsed, etc. with or by _Spotify.
          </p>
        </section>
        <section className="px-8 py-12 bg-purple text-white">
          <h1>Open Source</h1>
          <p className="mt-5">
            Reactify is completely open source so you can take a look at what we do with your data. (Nothing, cause
